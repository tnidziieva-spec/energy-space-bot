...
EVENTS = [
    {"date": "16 травня, 15:00", "title": "Скільки грошей тобі потрібно для стабільності?", "desc": "Юлія Новіцька - фінансовий консультант. Energy Space, Осокорки, ЖК RiverStone"},
]
...
def sizes_kb(item_key):
    it = MENU[item_key]
    row = [KeyboardButton(text=f"{'M' if s=='M' else 'L'} — {it['prices'][s]}₴") for s in it["sizes"]]
